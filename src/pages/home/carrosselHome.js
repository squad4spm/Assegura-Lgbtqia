    ...
    return (
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <a href="nomeSocial.php">
                        <div class="cardDescricaoN">
                            <h2>Nome social</h2>
                            <p class="textoCards">
                ...
                <div class="carousel-item">
                    <div class="cardDescricaoC">
                        <h2>Casa de acolhimento</h2>
                        <p class="textoCards">
