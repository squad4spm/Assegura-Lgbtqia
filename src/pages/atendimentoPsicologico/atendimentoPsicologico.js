...
export default () => {
  return (
    <Container fluid>
      ...
      <section id="pg_atendimento_psicologico_primeiraClass" class="container">
        <div class="row">
            <div class="col-md-6">
                <h3><br />Pessoas Precisando</h3>
                <p>Muitas pessoas LGBTQIA+  em São Paulo precisam de apoio psicológico. Mas muita dessas pessoas não conseguem acessar esse tipo de serviço. Seja por falta de grana, por falta de vagas. Então, pra fazer a conta fechar, queremos conectar pessoas LGBTQIA+ a profissionais de psicologia que queiram atendê-las de forma voluntária..</p>
            </div>
            <div class="col-md-6">
                <img src={psicologico2} class="img-fluid"/>
            </div>
        </div>
      </section>

      <section id="pg_atendimento_psicologico_segundaClass" class="container">
        <div class="row">
            <div class="col-md-6">
      ...
      <section class="container-fluid pg_atendimento_psicologico_terceiraClass">
        <div class="container">
            <div class="row my-3">
                <div class="col">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h3>QUERO AJUDAR!</h3>
                    <p>Profissionais de psicologia que topem ajudar de forma voluntária se cadastram, indicando onde estão.</p>
                </div>
                <div class="col-md-4">
                    <h3>PRECISO DE AJUDA!</h3>
                    <p>Pessoas LGBTQIA+ que precisam de acolhimento psicológico se cadastram pela plataforma, indicando onde estão.</p>
                </div>
                <div class="col-md-4">
                    <h3>DEU "MACTH"!</h3>
                    <p>Nossa equipe cruza os dados e conectamos quem precsa de acolhimento psicológico com profissionais que possam ajudar.</p>
                </div>
            </div>
      ...
      <section class="container-fluid pg_atendimento_psicologico_quartaClass">
          <div class="container">
                <div class="row my-3">
                  <div class="col">
                ...
                <div class="col-md-4">
                    <img src={casa1} class="mr-3 img-fluid" alt="Conheça a primeira Trans faixa-preta de Jiu-Jitsu" />
                ...
                <div class="col-md-4">
                    <img src={casa1} class="mr-3 img-fluid" alt="“Sem ver diferenças”: É possível diversidade e inclusão nos treinos de artes marciais?" />
                ...
                <div class="col-md-4">
                    <img src={casa_florecer} class="mr-3 img-fluid" alt="“Sem ver diferenças”: É possível diversidade e inclusão nos treinos de artes marciais?" />
